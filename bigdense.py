...
from srdense.thinnet import bigdensenet, L1_Charbonnier_loss
from srdense.dataset import DatasetFromfolder
from srdense.proj_utils.plot_utils import *


model_name = 'bigdensenet_super_resolution'
...
parser.add_argument("--resume", default=False, help="Path to checkpoint (default: none)")
parser.add_argument("--reload_epoch", default=1, type=int, help="Manual epoch number (useful on restarts)")
